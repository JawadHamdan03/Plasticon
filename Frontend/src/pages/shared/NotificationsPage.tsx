    ...
    <div style={{ display: "grid", gap: "1.5rem" }}>
      ...
      >
        ...
        <strong
          style={{
            fontSize: ".875rem",
            color: unread > 0 ? "var(--brand-primary)" : "var(--text-primary)",
          }}
        >
          {unread}
        </strong>
      ...
      <div
        ...
        style={{ gridTemplateColumns: isAdmin ? undefined : "1fr" }}
      >
        {/* Inbox */}
        <div
          style={{
              ...
              displayed.map((n) => (
                ...
                >
                  ...
                  <span
                    ...
                    style={{
                      color: TYPE_COLORS[n.type] ?? "var(--text-secondary)",
                    }}
                  >
                    {n.type.replace(/_/g, " ")}
                  </span>
