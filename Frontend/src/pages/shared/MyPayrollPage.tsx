...
export function MyPayrollPage() {
  ...
  const t = {
    ...
    subtitle: isAr
      ? "سجل الحضور اليومي والراتب المؤكد."
      : "Daily attendance and confirmed salary record.",
      ...
      <div className="payroll-summary-cards">
        <div className="payroll-summary-card payroll-summary-card--green">
          ...
          <div>
            ...
            <p className="payroll-summary-card__value">
              {confirmedTotal.toFixed(2)} <span>{t.nis}</span>
            </p>
          </div>
        </div>
        <div className="payroll-summary-card payroll-summary-card--orange">
          ...
          <div>
            ...
            <p className="payroll-summary-card__value">
              {pendingTotal.toFixed(2)} <span>{t.nis}</span>
            </p>
          </div>
        </div>
        <div className="payroll-summary-card">
          ...
          <div>
            ...
            <p className="payroll-summary-card__value">
              {(confirmedTotal + pendingTotal).toFixed(2)} <span>{t.nis}</span>
            </p>
          </div>
        </div>
        <div className="payroll-summary-card">
