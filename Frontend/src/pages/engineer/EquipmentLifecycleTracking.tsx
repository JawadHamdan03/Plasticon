  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-6">
        {[
          { label: nav("Operational", "تشغيلي"), value: operationalCount, icon: "⚡", color: "#059669", bg: "#d1fae5" },
          { label: nav("In Maintenance", "في الصيانة"), value: maintenanceCount, icon: "🔧", color: "#d97706", bg: "#fef3c7" },
          { label: nav("Broken / Offline", "معطل / غير متصل"), value: brokenCount, icon: "🚨", color: "#dc2626", bg: "#fee2e2" },
        ].map(k => (
