...
function downtimeBadgeClass(mins: number | null) {
  if (!mins || mins < 30)
    return "maintenance-downtime-badge maintenance-downtime-badge--low";
  if (mins < 90)
    return "maintenance-downtime-badge maintenance-downtime-badge--mid";
...
export function MaintenancePage() {
  ...
  const urgentCount = records.filter(
    (r) => (r.downtimeMinutes ?? 0) >= 60,
  ).length;
  const totalDowntime = records.reduce(
    (acc, r) => acc + (r.downtimeMinutes ?? 0),
    0,
  );
  ...
  const t = {
    ...
    subtitle:
      locale === "ar"
        ? "تقارير الصيانة والجرد الشهري"
        : "Maintenance reports & monthly inventory",
      ...
      <div className="maintenance-kpi-strip">
        ...
        <div className="maintenance-kpi">
          ...
          <span
            ...
            style={{ color: urgentCount > 0 ? "var(--red-600)" : undefined }}
          >
            {urgentCount}
          </span>
          <span className="maintenance-kpi__sub">
            {locale === "ar" ? "≥ 60 دقيقة توقف" : "≥ 60 min downtime"}
          </span>
        </div>
        <div className="maintenance-kpi">
          ...
          >
            {loading ? (
              ...
              <div style={{ padding: "2.5rem", textAlign: "center" }}>
                <Wrench
                  size={36}
                  style={{ color: "var(--gray-300)", margin: "0 auto .75rem" }}
                />
                <p
                  style={{
                    margin: 0,
              ...
              records.map((r) => (
                <div key={r.id} className="maintenance-report-item">
                  ...
                  <p className="maintenance-report-item__parts">
                    {locale === "ar" ? "القطع: " : "Parts: "}
                    <strong>{r.partsUsed}</strong>
                  </p>
            ...
            <div className="maintenance-card__body">
              <form className="module-form" onSubmit={(e) => void submit(e)}>
                <label>
                  ...
                  >
                    <option value="">
                      {locale === "ar" ? "اختر الآلة..." : "Select machine..."}
                    </option>
                    {machines.map((m) => (
                ...
                <label>
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setForm((p) => ({
                        ...p,
                        downtimeMinutes: e.target.value,
                      }))
                    }
                    placeholder="0"
                  />
                ...
                <label>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setForm((p) => ({ ...p, downtimeReason: e.target.value }))
                    }
                  >
          ...
          >
            ...
            >
              ...
              <p style={{ margin: ".25rem 0 0", fontSize: ".78rem" }}>
                {locale === "ar"
                  ? "انقر لإضافة تقرير صيانة"
                  : "Click to add maintenance report"}
              </p>
            </div>
          </div>
        )}
