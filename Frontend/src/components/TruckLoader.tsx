...
export function TruckLoader({ className = "" }: TruckLoaderProps) {
  return (
    <div className={`truck-loader ${className}`.trim()}>
      <div className="truck-loader__wrapper">
        <div className="truck-loader__body">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 198 93"
            className="truck-loader__truck-svg"
          >
            <path
              strokeWidth="3"
              stroke="#A2AF9B"
        ...
        <div className="truck-loader__tires">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 30 30"
            className="truck-loader__tire-svg"
          >
            <circle
              strokeWidth="3"
              stroke="#A2AF9B"
              ...
              cx="15"
            />
            <circle fill="#EEEEEE" r="7" cy="15" cx="15" />
          </svg>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
        ...
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
          id="truck-loader-lamp"
          version="1.1"
          fill="#A2AF9B"
          className="truck-loader__lamp-post"
        >
