...
const ITEMS = [
  { icon: 'receipt',       label: 'Expense Tracking',      desc: 'Log and categorise all business expenses',       screen: 'Expenses',            color: colors.danger },
  { icon: 'swap-horizontal', label: 'Bank Reconciliation', desc: 'Match bank statements with recorded transactions', screen: 'BankReconciliation', color: colors.success },
  { icon: 'calculator',   label: 'Tax Compliance',         desc: 'Manage tax filings and compliance reports',      screen: 'TaxCompliance',      color: colors.warning },
];
  ...
  return (
    <SafeAreaView style={styles.safe}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={styles.sub}>Expense management and compliance</Text>
